  <?php echo '<input type="hidden" name="spa" value="5">';?>
  <div class="site-wrap">
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../prof_Boot/images/bg_1.jpg')">
	    <div class="container">
	      <div class="row align-items-end justify-content-center text-center">
	        <div class="col-lg-12">
	          <h2 class="mb-0" style="margin-top:50px;"><i class="fa fa-newspaper-o"></i> Latest News</h2>
	        </div>
	      </div>
	    </div>
	 </div> 
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Latest News</span>
      </div>
    </div>
            ...
            <div class="row" style="border:1px solid #aeaeae;padding-left:10px;">
              ...
              <div style="padding:5px;">
                <ul class="monoaa">
                  ...
                  <a href="latestnews"><li style="border-bottom:1px solid #dedede;padding:10px;color:#6B6665;font-weight:bold"> Latest News</li></a>
                  ...
                  <a href="downloadables"><li style="border-bottom:1px solid #dedede;padding:10px;color:#6B6665"> Downloadables</li></a>
                </ul>
              </div>
            </div>
          </div>
          <div class="col-md-9">
            <div id="cntenthere"></div>
            <div style="padding:20px;border-bottom:0.5px solid #dedede;border-top:0.5px solid #dedede;margin-top:20px; ">
              <center>
                <font id="shwMrrr" style="cursor:pointer;color:blue;display:none;">Show more news</font>
              </center>
            </div>
          </div>
        </div>
