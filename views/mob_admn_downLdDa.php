        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <div style="padding:10px;border-bottom:1px solid #aeaeae;">
                    <font class="btn btn-primary" style="float:right;margin-top:5px;" data-toggle="modal" data-target=".bs-ascawwwww-modal-lg">+ &nbsp Upload File for Download</font>
                    <h1>Downloadable Files (for External Page users only)</h1>
                </div>
                <div style="padding:10px;">
                    <font id="PlxxoInfoCCx" style="float:right;margin-top:5px;font-size:21px;"></font>
                    <h5>No modification for this area.. Validate your entry before the submission.</h5>
                    <div style="padding-top:10px;">
                        <style type="text/css">
                            .POdata{cursor:pointer;background:none;}
                            .POdata:hover{background:#b9cae5;}
                        </style>
                        <table width="100%">
                            <thead>
                                <tr style="background:black;color:white;">
                                    <td style="padding:5px;">Line #.</td>
                                    <td style="padding:5px;">File Description</td>
                                    <td style="padding:5px;">Filename</td>
                                    <td style="padding:5px;">Date & Time Added</td>
                                    <td style="padding:5px;">Control</td>
                                </tr>
                            </thead>
                            <tbody id="lssevntActxxx1wxxDnwfile"></tbody>
                        </table>
                    </div>
