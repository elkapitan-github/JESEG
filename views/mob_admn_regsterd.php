            ...
            <div class="right_col" role="main">
                <div class="col-md-12" style="padding:0px;font-size:12px;">
                    <div id="generalActvResearchrs1" class="col-md-2 topMenu1" style="border-bottom:2px solid #f77b67;">
                        Author &nbsp&nbsp(<font id="ggInf1"></font>)<i class="fa fa-copy" style="float:right;font-size:16px;"></i>
                    </div>
                    ...
                    <div id="vid1div1" class="col-md-4" style="text-align:right">
                        <font style="float:right;margin-top:2px;">Search: <input type="text" id="vid1div1op" name="vid1div1op" placeholder="Type here..." style="padding-left:4px;width:200px;border-radius:5px;"> <font id="goSear1x1" class="btn btn-default" style="padding:1px;padding-right:7px;padding-left:7px;box-shadow:none;">Go</font>
                        <font id="srOopXx_sr1" class="btn btn-default" style="padding:1px;padding-right:7px;padding-left:7px;box-shadow:none;">Reset</font>
                    </font>
                    </div>
                    <div id="vid1div2" class="col-md-4" style="text-align:right;display:none;">
                        <font style="float:right;margin-top:2px;">Search: <input type="text" id="vid1div2op" name="vid1div2op" placeholder="Type here..." style="padding-left:4px;width:200px;border-radius:5px;"> <font id="goSear1x2" class="btn btn-default" style="padding:1px;padding-right:7px;padding-left:7px;box-shadow:none;">Go</font>
                        <font id="srOopXx_sr2" class="btn btn-default" style="padding:1px;padding-right:7px;padding-left:7px;box-shadow:none;">Reset</font>
                    </font>
                    </div>
                    <div id="vid1div3" class="col-md-4" style="text-align:right;display:none;">
                        <font style="float:right;margin-top:2px;">Search: <input type="text" id="vid1div3op" name="vid1div3op" placeholder="Type here..." style="padding-left:4px;width:200px;border-radius:5px;"> <font id="goSear1x3" class="btn btn-default" style="padding:1px;padding-right:7px;padding-left:7px;box-shadow:none;">Go</font>
                        <font id="srOopXx_sr3" class="btn btn-default" style="padding:1px;padding-right:7px;padding-left:7px;box-shadow:none;">Reset</font>
                    </font>
                    </div>
                </div>
