        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <div style="padding:10px;border-bottom:1px solid #aeaeae;">
                    <font class="btn btn-primary" style="float:right;margin-top:5px;" data-toggle="modal" data-target=".bs-latNews-modal-lg">+ &nbsp Add Latest News</font>
                    <h1>Latest News</h1>
                </div>
                <div style="padding:10px;">
                    <h5>No modification for this area.. Validate your entry before the submission.</h5>
                    <div id="cntPlxxllssl"></div>
