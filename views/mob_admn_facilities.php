        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <div style="padding:10px;border-bottom:1px solid #aeaeae;">
                    <font class="btn btn-primary" style="float:right;margin-top:5px;" data-toggle="modal" data-target=".bs-addSectionFac-modal-sm">+ &nbsp Add Facility Section</font>
                    <h1 style="font-size:29px;">R&D Facilities</h1>
                    <small style="color:red">Viewable by public <i class="fa fa-eye"></i></small>
                </div>
                <div id="asdwwwxxww1231x" style="padding:10px;">
                </div>
