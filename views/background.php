  <?php echo '<input type="hidden" name="spa" value="4">';?>
  <div class="site-wrap">
          ...
          <div class="ml-auto">
            ...
            <nav id="navmy2" style="display:none;">
              <div style="padding:3%;border-bottom:1px solid #aeaeae;">
                &nbsp&nbsp<img src="<?php echo base_url('../img/jeseg.png');?>" style="width:30px;"> Site Map
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../../prof_Boot/images/bg_1.jpg')">
	    <div class="container">
	      <div class="row align-items-end justify-content-center text-center">
	        <div class="col-lg-12">
	          <h2 class="mb-0" style="margin-top:50px;"><i class="fa fa-trophy"></i> Our Background</h2>
	        </div>
	      </div>
	    </div>
	 </div> 
    ...
    <div class="site-section">
        <div class="container" style="font-size:21px;text-align:justify;">

           &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The Journal of Ecosystem Science and Eco-Governance (JESEG) is an international peer-reviewed journal
dedicated to biodiversity, environmental science, ecology, conservation biology, ecosystems services and its
contribution to the quality of life. The journal aims to provide recommendations and policies relevant for
decision making on landscape ecology, land-use planning and biodiversity conservation for sustainable and
equitable eco-governance of these resources.The journal is in English and is published semi-annually (June
and December) in both online and print versions.
          <br><br><br>
          <h4>Email: jeseg@carsu.edu.ph</h4>
          <h4>Phone: (085) 341-2296</h4>
        </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5" style="padding-right:5%">
            ...
            <p>
              <b>journal of ECOSYSTEM SCIENCES AND ECO-GOVERNANCE</b><Br>
