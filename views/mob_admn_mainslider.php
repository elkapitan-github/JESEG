        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                <div style="padding:10px;border-bottom:1px solid #aeaeae;">
                    <font class="btn btn-primary" style="float:right;margin-top:5px;" data-toggle="modal" data-target=".bs-changePhot-modal-lg">+ &nbsp Update Slider</font>
                    <h1>Main Slider</h1>
                </div>
                <div style="padding:10px;">
                    <div id="sliddpPPOxx" style="padding:10px;">
                    </div>
                </div>
            </div>
            <!-- /page content -->
