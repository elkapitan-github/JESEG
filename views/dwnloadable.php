  <?php echo '<input type="hidden" name="spa" value="9">';?>
  <div class="site-wrap">
          ...
          <div class="col-md-4">
            <table width="100%">
              <tr>
                ...
                <td style="width:35%">
                  <a href="pubartic"><button class="btn btn-primary" style="padding:9px;background:#6C6969;margin-top:20px;">Search Article &nbsp&nbsp <i class="fa fa-search"></i></button></a>
                </td>
              </tr>
            </table>
          </div>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../prof_Boot/images/bg_1.jpg')">
	    <div class="container">
	      <div class="row align-items-end justify-content-center text-center">
	        <div class="col-lg-12">
	          <h2 class="mb-0" style="margin-top:50px;"><i class="fa fa-download"></i> Downloadables</h2>
	        </div>
	      </div>
	    </div>
	 </div> 
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Downloadables</span>
      </div>
    </div>



    <div class="news-updates" style="">
      <div class="container">
        <div class="row" style="font-size:16px;">
            ...
            <div class="row" style="border:1px solid #aeaeae;padding-left:10px;">
              ...
              <div style="padding:5px;">
                <ul class="monoaa">
                  ...
                  <a href="<?php echo base_url();?>"><li style="border-bottom:1px solid #dedede;padding:10px;color:#6B6665;"> About this Journal</li></a>
                  <a href="latestnews"><li style="border-bottom:1px solid #dedede;padding:10px;color:#6B6665"> Latest News</li></a>
                  <a href="pubartic"><li style="border-bottom:1px solid #dedede;padding:10px;color:#6B6665"> Current Issues</li></a>
                  <a href="EditorialBoard"><li style="border-bottom:1px solid #dedede;padding:10px;color:#6B6665"> Editorial Board</li></a>
                  <a href="downloadables"><li style="border-bottom:1px solid #dedede;padding:10px;color:#6B6665;font-weight:bold"> Downloadables</li></a>
                </ul>
              </div>
            </div>
          </div>
          <div class="col-md-9">
            <div>
              <h3 class="mb-3" style="border-bottom:0.2px solid #dedede;width:100%;">
                <center><small style="font-size:12px;">Click to download</small></center>
              </h3>
            </div>
            <div class="fox" style="height:460px;overflow:auto;">
              <?php
              $xx = 0;$i = 0;
              foreach ($downldld as $key) {
                $i ++;
                if($xx % 2 == 0){
                  echo '<div style="background:#f2f2f2;"><a target="__blank" href="'.base_url().'/../../docs/'.$key->filename.'" title="Download: '.$key->filename.'"><div style="padding:5px;">
                    <font style="float:right"><small>Date Updated: '.$key->date.' | '.$key->time.'</small></font>
                    <font style="color:black;font-size:15px;">&nbsp&nbsp'.$i.'. &nbsp<b>'.$key->filedesc.'</b></font>
                  </div></a></div>';
                }else{
                  echo '<div style="background:white;"><a target="__blank" href="'.base_url().'/../../docs/'.$key->filename.'" title="Download: '.$key->filename.'"><div style="padding:5px;">
                  <font style="float:right"><small>Date Updated: '.$key->date.' | '.$key->time.'</small></font>
                    <font style="color:black;font-size:15px;">&nbsp&nbsp'.$i.'. &nbsp<b>'.$key->filedesc.'</b></font>
                  </div></a></div>';
                }
