  <?php echo '<input type="hidden" name="spa" value="8">';?>
  <div class="site-wrap">
          ...
          <div class="mr-auto" id="osss">
            <nav id="navmy1" class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu">
                ...
                <li class="has-children">
                  <a class="text-left" style="color:#be2634">Research and Innovation</a>
          ...
          <div class="ml-auto">
            ...
            <nav id="navmy2" style="display:none;">
              ...
              <ul style="display:inline-grid;margin-left:-8%;margin-top:2%;cursor:pointer;width:100%;">
                ...
                <li class="has-children">
                  <div id="click1">About Us <i class="fa fa-sort-down" style="float:right;margin-top:3px;"></i></div>
                ...
                <li class="has-children">
                  <div id="click2" style="color:#be2634">Research and Innovation <i class="fa fa-sort-down" style="float:right;margin-top:3px;"></i></div>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../../prof_Boot/images/bg_1.jpg')">
	    <div class="container">
	      <div class="row align-items-end justify-content-center text-center">
	        <div class="col-lg-12">
	          <h2 class="mb-0" style="margin-top:50px;"><i class="fa fa-book"></i> Research Agenda</h2>
	        </div>
	      </div>
	    </div>
	 </div> 
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Research Agenda</span>
      </div>
    </div>
    ...
    <div class="footer">
      <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <div class="copyright">
              <font style="font-size:15px;"><b>Caraga State University</b></font><br>The Journal of Ecosystem Sciences and Eco-Governance<br><font style="font-size:18px;"><b>--&nbsp J E S E G &nbsp--</b></font>
                <p>
