...
<html lang="en">
    <head>
        ...
        <script src="<?php echo base_url();?>js/admin2.js"></script>
        ...
        <style type="text/css">
            ...
            #hovArt{font-size:11px;margin-top:-9px;margin-right:10px;background:white;padding:4px;box-shadow:0px 1px 3px rgba(0, 0, 0, .23);padding-left:8px;padding-right:8px;cursor:pointer;border-radius:0px 0px 5px 5px;width:170px;}
